	...
	<el-container class="syh-container">
		<el-header>
				...
				<div class="syh-editdata">
					<el-input v-model="searchInput" placeholder="请输入支付商家ID" clearable size="small" prefix-icon="el-icon-search"></el-input>
			...
			<div class="syh-dialog">
				<el-dialog title="详情" :visible.sync="detailsVisible" width="40%" top="30vh" custom-class="rowDetails">
					<table>
						...
						<tr>
							<td>应用支付回调地址：</td>
							<td>{{detailData.callbackAddress}}</td>
							<td>数据格式：</td>
							<td>{{detailData.jtname}}</td>
						</tr>
						<tr>
							<td>应用支付地址：</td>
							<td>{{detailData.applyAddress}}</td>
							<td>字符集：</td>
							<td>{{detailData.jtname}}</td>
						</tr>
						<tr>
							<td>支付服务商地址：</td>
							<td>{{detailData.payAddress}}</td>
							<td>加密方式：</td>
							<td>{{detailData.jtname}}</td>
						</tr>
						<tr>
							<td>支付商家ID：</td>
							<td>{{detailData.merchantId}}</td>
						</tr>
					</table>
				</el-dialog>
			</div>
			<div class="syh-dialog">
				<el-dialog :visible.sync="editVisible" width="55%" top="20vh" custom-class="rowEdit">
					<span slot="title" class="el-dialog__title">{{dialogTitle}}</span>
					<el-form :model="editDatasForm" ref="editDatasForm" hide-required-asterisk label-width="150px" inline :rules="rules">
						<table>
							<tr>
								<td>
								...
								<td>
									<el-form-item label="支付秘钥" prop="jtcode">
										<el-input placeholder="请输入支付秘钥" v-model="editDatasForm.jtcode"></el-input>
									</el-form-item>
								</td>
							</tr>
							<tr>
								...
								<td>
									<el-form-item label="启用状态" prop="jtname">
										<el-input placeholder="请输入启用状态" v-model="editDatasForm.jtname"></el-input>
									</el-form-item>
								</td>
							</tr>
							<tr>
								<td>
									<el-form-item label="应用支付回调地址" prop="callbackAddress">
										<el-input placeholder="请输入应用支付回调地址" v-model="editDatasForm.callbackAddress"></el-input>
									</el-form-item>
								</td>
								<td>
									<el-form-item label="数据格式" prop="statetext">
										<el-input placeholder="请输入数据格式" v-model="editDatasForm.jtname"></el-input>
									</el-form-item>
								</td>
							</tr>
							<tr>
								<td>
									<el-form-item label="应用支付地址" prop="applyAddress">
										<el-input placeholder="请输入应用支付地址" v-model="editDatasForm.applyAddress"></el-input>
									</el-form-item>
								</td>
								<td>
									<el-form-item label="字符集" prop="statetext">
										<el-input placeholder="请输入字符集" v-model="editDatasForm.jtname"></el-input>
									</el-form-item>
								</td>
							</tr>
							<tr>
								<td>
									<el-form-item label="支付服务商地址" prop="payAddress">
										<el-input placeholder="请输入支付服务商地址" v-model="editDatasForm.payAddress"></el-input>
									</el-form-item>
								</td>
								<td>
									<el-form-item label="加密方式" prop="statetext">
										<el-input placeholder="请输入加密方式" v-model="editDatasForm.jtname"></el-input>
									</el-form-item>
								</td>
							</tr>
							<tr>
								<td>
									<el-form-item label="支付商家ID" prop="merchantId">
										<el-input placeholder="请输入支付商家ID" v-model="editDatasForm.merchantId"></el-input>
									</el-form-item>
								</td>
							</tr>
						</table>
...
export default {
	...
	data () {
		return {
			...
			tableData: [{
				zzname: '速邮汇',
				merchantId: '196.168.21',
				payAddress: 'https://www.baidu.com/',
				applyAddress: 'https://www.baidu.com/',
				callbackAddress: 'https://www.baidu.com/',
				state: '1'
			}, {
				zzname: '速邮汇',
				merchantId: '196.168.21',
