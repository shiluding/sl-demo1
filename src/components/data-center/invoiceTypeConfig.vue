	...
	<el-container class="syh-container">
		<el-header>
				<el-breadcrumb separator="/">
					...
					<el-breadcrumb-item>单据类型配置</el-breadcrumb-item>
				</el-breadcrumb>
				<div class="syh-editdata">
					<el-input v-model="searchInput" placeholder="请输入单据编码或名称" clearable size="small"></el-input>
			...
			<div class="syh-dialog">
				<el-dialog title="详情" :visible.sync="detailsVisible" width="40%" top="30vh" custom-class="rowDetails">
					<table>
						<tr>
							<td>单据类型编码：</td>
							<td>{{detailData.invoiceCode}}</td>
							<td>修改时间：</td>
							<td>{{detailData.updateTime}}</td>
						</tr>
						<tr>
							<td>单据类型名称：</td>
							<td>{{detailData.invoiceName}}</td>
							<td>所属组织编码：</td>
				...
				<el-dialog :visible.sync="editVisible" width="42%" top="20vh" custom-class="rowEdit">
					...
					<el-form :model="editDatasForm" ref="editDatasForm" hide-required-asterisk label-width="100px" inline :rules="rules">
						<table>
							<tr>
								<td>
									<el-form-item label="单据类型编码" prop="invoiceCode">
										<el-input placeholder="请输入单据类型编码" v-model="editDatasForm.invoiceCode"></el-input>
									</el-form-item>
								</td>
								<td>
									<el-form-item label="修改时间" prop="updateTime">
										<el-input placeholder="请输入启用状态" v-model="editDatasForm.updateTime"></el-input>
									</el-form-item>
								</td>
							</tr>
							<tr>
								<td>
									<el-form-item label="单据类型名称" prop="invoiceName">
										<el-input placeholder="请输入单据类型名称" v-model="editDatasForm.invoiceName"></el-input>
									</el-form-item>
								</td>
								<td>
