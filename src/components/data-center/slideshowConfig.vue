			...
			<div class="syh-dialog">
				<el-dialog title="详情" :visible.sync="detailsVisible" width="40%" top="30vh" custom-class="rowDetails">
					<table>
						<tr>
							<td>轮播图名称：</td>
							<td>{{detailData.slideName}}</td>
							<td>启用状态：</td>
							<td>{{detailData.state}}</td>
						</tr>
						<tr>
							<td>轮播图链接：</td>
							<td>{{detailData.slideUrl}}</td>
							<td>创建时间：</td>
				...
				<el-dialog :visible.sync="editVisible" width="42%" top="20vh" custom-class="rowEdit">
					...
					<el-form :model="editDatasForm" ref="editDatasForm" hide-required-asterisk label-width="100px" inline :rules="rules">
						<table>
							<tr>
								<td>
									<el-form-item label="轮播图名称" prop="slideName">
										<el-input placeholder="请输入轮播图名称" v-model="editDatasForm.slideName"></el-input>
									</el-form-item>
								</td>
								<td>
							...
							<tr>
								<td>
									<el-form-item label="轮播图链接" prop="slideUrl">
										<el-input placeholder="请输入轮播图链接" v-model="editDatasForm.slideUrl"></el-input>
									</el-form-item>
								</td>
								<td>
							...
							<tr>
								...
								<td>
									<el-form-item label="更新时间" prop="updateTime">
										<!-- <el-input placeholder="请输入创建时间" v-model="editDatasForm.updateTime"></el-input> -->
									</el-form-item>
								</td>
							</tr>
							<tr>
